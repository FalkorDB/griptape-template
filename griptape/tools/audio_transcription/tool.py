...
class AudioTranscriptionTool(BaseTool):
    ...
    audio_loader: AudioLoader = field(
        default=Factory(lambda: AudioLoader()), kw_only=True
    )
    ...
    @activity(
        config={
            ...
            "schema": Schema(
                {
                    Literal(
                        "path", description="The paths to an audio file on disk."
                    ): str
                }
            ),
        },
    ...
    def transcribe_audio_from_memory(
        ...
        audio_artifact = cast(
            ...
            load_artifact_from_memory(
                memory, artifact_namespace, artifact_name, AudioArtifact
            ),
        )
