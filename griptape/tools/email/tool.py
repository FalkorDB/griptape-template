...
class EmailTool(BaseTool):
    ...
    smtp_user: Optional[str] = field(
        default=Factory(lambda self: self.username, takes_self=True), kw_only=True
    )
    smtp_password: Optional[str] = field(
        default=Factory(lambda self: self.password, takes_self=True), kw_only=True
    )
            ...
            "schema": Schema(
                {
                    ...
                    schema.Optional(
                        Literal("max_count", description="Optional max email count")
                    ): int,
                },
            ),
        },
    ...
    def retrieve(self, params: dict) -> ListArtifact | ErrorArtifact:
        ...
        max_count = (
            ...
            if values.get("max_count") is not None
