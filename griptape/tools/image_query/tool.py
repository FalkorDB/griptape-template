...
class ImageQueryTool(BaseTool):
    ...
    image_loader: ImageLoader = field(
        default=Factory(lambda: ImageLoader()), kw_only=True
    )
            ...
            "schema": Schema(
                {
                    ...
                    Literal(
                        "image_paths",
                        description="The paths to an image files on disk.",
                    ): Schema([str]),
                },
            ),
        },
            ...
            "schema": Schema(
                {
                    ...
                    Literal(
                        "image_artifacts",
                        description="Image artifact memory references.",
                    ): [
